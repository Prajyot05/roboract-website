...
const LandingPage = () => {
  return (
    <div id='Home' className='landing-page h-screen overflow-x-clip relative flex justify-center flex-col items-center'>
      ...
      <div className='main border-solid border-white border-[3px] p-[3vw] pt-[5vw] pb-[5vw] h-[50%] shadow-lg bg-[#fff2f2] w-[75vw] flex flex-col justify-center rounded-[1.5rem]'>
