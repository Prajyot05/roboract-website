...
const AboutPage = () => {
  return (
    <div id='About' className='about-page h-screen overflow-x-clip relative flex justify-center flex-col items-center'>
