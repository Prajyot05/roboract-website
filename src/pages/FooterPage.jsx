  ...
  return (
    <div className='footer-page text-white overflow-clip relative bg-black  font-light h-screen '>
      ...
      <div className="footercontent p-[5vw] flex h-[95%] justify-between items-center text-center">
        ...
        <div className="footermap w-[30vw] h-[20vw] relative overflow-hidden z-10">
        <div className="footermap-overlay cursor-pointer z-20 absolute w-full h-full hover:bg-black/50" onClick={() => window.open("https://google.com", "_blank")}></div>
          <img className='object-cover object-center scale-150' src="/assets/map.png" alt="" />
        </div>
      </div>
